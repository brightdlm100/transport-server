...
import com.hyd.domain.repository.LearnResouce;
...
public class LearnResourceController {
    ...
    public ModelAndView index(){
        ...
        learnList.add(bean);
        bean =new LearnResouce("官方SpringBoot例子","官方SpriongBoot例子","https://github.com/spring-projects/spring-boot/tree/master/spring-boot-samples");
        learnList.add(bean);
